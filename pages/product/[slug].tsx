          ...
          <section className="lg:pt-12 pt-24 pb-20 lg:px-28 sm:px-8 px-6">
            <div className="grid md:grid-cols-4 grid-cols-2 gap-10">
              ...
              <div className="md:col-span-2 col-span-2">
                ...
                <div className="grid grid-cols-4 mt-8 gap-6 font-quicksand">
                  <Link
                    href="/"
                    className="py-4 lg:col-span-2 col-span-4 grid place-content-center text-base font-semibold rounded-md bg-gray-50 shadow-[0_0px_4px_-1.76px_rgba(0,0,0,0.3)] "
                  >
                    More from shopperCart
                  </Link>
                  {state.singleProduct[0]?.phone_no ? (
                    <a
                      href={`tel:${state.singleProduct[0]?.phone_no}`}
                      className="py-4 lg:col-span-2 col-span-4 grid place-content-center text-base font-semibold text-green-400 bg-slate-800 rounded-md shadow-[0_0px_4px_-1.76px_rgba(0,0,0,0.3)]  "
                    >
