    ...
    <>
      ...
      <section className="lg:pt-6 pt-10 lg:px-16 sm:px-8 px-6 pb-16">
        <div className="grid place-content-end">
          <Link
            href="/dashboard"
            className="font-semibold font-quicksand  text-base text-center px-8 py-3 bg-red-400 text-white mb-8 rounded-md"
          >
            Dashboard
          </Link>
        </div>
...
StoreProfile.getLayout = function PageLayout(page: ReactElement) {
  return <>{page}</>;
};
